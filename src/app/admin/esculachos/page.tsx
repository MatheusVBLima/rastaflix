...
export default async function AdminEsculachosPage() {
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Gerenciamento de Esculachos</h1>
      
      <div className="bg-muted/50 p-10 rounded-lg text-center">
        <h2 className="text-xl mb-4">Em desenvolvimento</h2>
        <p className="text-muted-foreground">
          O módulo de gerenciamento de esculachos ainda está em desenvolvimento.
          <br />
          Em breve você poderá adicionar, editar e excluir esculachos.
        </p>
      </div>
    </div>
  );
